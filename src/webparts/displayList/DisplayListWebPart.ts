...
import * as strings from 'displayListStrings';
import { IDisplayListWebPartProps } from './IDisplayListWebPartProps';
...
export default class DisplayListWebPart extends BaseClientSideWebPart<IDisplayListWebPartProps> {
  ...
  public render(): void {
    ...
    Log.verbose('DisplayList WP', 'Invoking render');
   ...
   private _renderListAsync(): void {
     ...
     this.domElement.innerHTML = `
        <div className='wrapper'>
          ...
          <div class="ms-Grid ${styles.displayList}" }>
